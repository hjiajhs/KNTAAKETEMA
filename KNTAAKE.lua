...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/hjiajhs/KNTAAKETEMA/master/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(942979469) then  
var = true  
...
os.execute('wget https://raw.githubusercontent.com/hjiajhs/KNTAAKETEMA/master/KNTAAKE.lua')
send(msg.chat_id_, msg.id_,' ⌔┆ تم تحديث السورس \n ⌔┆ لديك اخر اصدار لسورس ارنغل /n ⌔┆ الاصدار » { 1.0v}')
dofile('KNTAAKE.lua')  
end
if text == 'الاصدار ⌔' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔┆ اصدار سورس ارنغل /n ⌔┆ الاصدار »{ 1.0v}')
end
...
࿕︙ E𝚁𝙰𝙽𝙶𝙴𝙻 ⩫ 𝖲𝗈𝗎𝗋𝖼𝖾(t.me/Erange_l)   .

࿕︙ ToolS E𝚁𝙰𝙽𝙶𝙴𝙻 ⩫(t.me/SBB_B)  .

 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
࿕  . E𝚁𝙰𝙽𝙶𝙴𝙻 ⩫ ⁦♬⁩(t.me/Erange_l) 
send(msg.chat_id_, msg.id_,Text)
return false
end
--------------------------------------------------------------------------------------------------------------
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/hjiajhs/KNTAAKETEMA/master/File_Bot/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌔┆ اهلا بك في متجر ملفات ارنغل\n ⌔┆ ملفات السورس ↓\n≪°•°•°•°•°•°∞°•°•°•°•°•°≫\n\n"
local TextE = "\n≪°•°•°•°•°•°∞°•°•°•°•°•°≫\n ⌔┆ علامة تعني { ✓ } ملف مفعل\n ⌔┆ علامة تعني { ✘ } ملف معطل\n ⌔┆ قناة سورس ميرمار↓\n".." ⌔┆ [اضغط هنا لدخول](t.me/@Erange_l) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/hjiajhs/KNTAAKETEMA/master/File_Bot/"..file)
if res == 200 then
...
send(msg.chat_id_, msg.id_," ⌔┆ عذرا الملف لايدعم سورس ارنغل\n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ارنغل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ارنغل')
local KNTAAKE_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
*⌔م10 ◂ اوامر الاعضاء*
ٴ≪°•°•°•°•°•°∞°•°•°•°•°•°≫ٴ
彡 .[𝘚𝘰𝘶𝘳𝘤𝘦 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/Erange_l)➢ 
]]
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ولك هيو لتندك بسيادك لو بهاي 👞👈","ميستاهل اتعبي روحي ويا لانه عار","عوفه يروحي هاذا حدث  مال تلي"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
